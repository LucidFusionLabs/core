 ...
 */
extern C_LINKAGE int SDL_main(int argc, const char *argv[]);
 ...
 */
extern DECLSPEC int SDLCALL SDL_WinRTRunApp(int (*mainFunction)(int, const char **), void * xamlBackgroundPanel);
