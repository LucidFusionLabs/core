...
include $(CLEAR_VARS)
LOCAL_MODULE := master
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../android/master/libmaster.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := lfapp
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../android/master/master_lfapp_obj/libmaster_lfapp.a
include $(PREBUILT_STATIC_LIBRARY)
...
LOCAL_STATIC_LIBRARIES := master lfapp Box2D libpng libjpeg-turbo
