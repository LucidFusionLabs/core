...
See lflpub/README for build procedure on all platforms
When changing platform configurations within same checkout directory: rm -rf lflpub/imports; svn up
