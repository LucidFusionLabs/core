...
include $(CLEAR_VARS)
LOCAL_MODULE := market
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../android/market/libmarket.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := lfapp
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../android/market/market_lfapp_obj/libmarket_lfapp.a
include $(PREBUILT_STATIC_LIBRARY)
...
LOCAL_STATIC_LIBRARIES := market lfapp Box2D libpng libjpeg-turbo
