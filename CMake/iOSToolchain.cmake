...
set(CMAKE_OSX_ARCHITECTURES ${LFL_IOS_ARCH} CACHE STRING "iOS arch" FORCE)
...
if(CMAKE_GENERATOR MATCHES Xcode)
  ...
  set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -isysroot ${LFL_IOS_SDK} ${IOS_VERSION_MIN}")
  add_definitions("-isysroot ${LFL_IOS_SDK} ${IOS_VERSION_MIN_FULL}")
endif()

set(ENV_CFLAGS   "${LFL_IOS_ARCH_FLAGS} -isysroot ${LFL_IOS_SDK} ${IOS_VERSION_MIN}")
set(ENV_CXXFLAGS "${LFL_IOS_ARCH_FLAGS} -isysroot ${LFL_IOS_SDK} ${IOS_VERSION_MIN}")
set(ENV_LDFLAGS  "${LFL_IOS_ARCH_FLAGS} -isysroot ${LFL_IOS_SDK} ${IOS_VERSION_MIN}")
