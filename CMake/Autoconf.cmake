...
macro (autoconf_make _make _makefile _target)
    set(autoconf_built ${CMAKE_CURRENT_BIN_DIR}/.built)
    if(NOT EXISTS ${autoconf_built})
        MESSAGE(STATUS "run ${_make} -f ${CMAKE_CURRENT_SOURCE_DIR}/${_makefile} ${_target} in ${CMAKE_CURRENT_BIN_DIR}")
        execute_process(
                COMMAND
...
macro (autoconf_exec _cmd)
    set(autoconf_built ${CMAKE_CURRENT_BIN_DIR}/.built)
    if(NOT EXISTS ${autoconf_built})
    MESSAGE(STATUS "run ${_cmd} in ${CMAKE_CURRENT_BIN_DIR}")
