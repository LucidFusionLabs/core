...
function(lfl_add_target _name)
  ...
  set_property(TARGET ${_name} PROPERTY NO_SYSTEM_FROM_IMPORTED 1)
  if(_LINK_LIBRARIES)
  ...
  if(_EXECUTABLE AND LFL_ADD_BITCODE_TARGETS)
    ...
    set_property(TARGET ${_name}_bitcode PROPERTY NO_SYSTEM_FROM_IMPORTED 1)
    ...
    set_property(TARGET ${_name}_designer PROPERTY NO_SYSTEM_FROM_IMPORTED 1)
