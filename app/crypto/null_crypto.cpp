...
Crypto::CipherAlgo Crypto::CipherAlgos::DES_CBC()      { FATAL("not implemented"); }
Crypto::CipherAlgo Crypto::CipherAlgos::DES_ECB()      { FATAL("not implemented"); }
...
int Crypto::CipherOpen(Cipher c, CipherAlgo algo, bool dir, const StringPiece &key, const StringPiece &IV, int, int) { FATAL("not implemented"); }
